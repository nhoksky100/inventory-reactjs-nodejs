...
// router.post('/listSendFriend', async (req, res) => {
//     const data = await readJsonFile(listSendFiendJSON);
//     const { dataFriend, statusSendFriend, dataFriendSender } = req.body;
//     const index = data.findIndex(friend => friend.email === dataFriend.email);
//     if (index !== -1) {
//         data[index].statusSendFriend = statusSendFriend;
//     } else {
//         data.push({
//             id: dataFriend.id,
...
//         });
//     }
//     await writeJsonFile(listSendFiendJSON, data);
//     res.json(data);
// });

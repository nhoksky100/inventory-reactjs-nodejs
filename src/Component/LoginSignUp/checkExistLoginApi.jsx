...
// export const checkExistLoginApi = (dataLogin) => {
//     const getDataAccountCustomer = () => axios.get('/getAccount').then((res) => res.data);

//     if (dataLogin) {
       
//         let flagExist = false;
//         let hasExecutedCondition = false; // Biến để kiểm tra xem đã thực hiện điều kiện hay chưa

//         getDataAccountCustomer()
//             .then((res) => {
//                 res.forEach((value) => {
//                     // console.log(value,'value');
//                     if (value.email === dataLogin.email) {
//                         flagExist = true;
//                         // console.log('co ton tai',dataLogin.id);
//                     }
//                 });
//             })
//             .catch((error) => {

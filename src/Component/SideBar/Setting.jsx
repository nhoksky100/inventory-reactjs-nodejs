...
const mapDispatchToProps = (dispatch, ownProps) => {
    return {
        ISDISABLEINPUT: (action_isDisableInput) => {
            dispatch({ type: 'isDisableInput', action_isDisableInput })
        },
        ISCONFIRM: (action_isConfirm) => {
            dispatch({ type: 'isConfirm', action_isConfirm })
        },
        ISCLEARFORMINPUT: (action_isClearFormInput) => {
            dispatch({ type: 'isClearFormInput', action_isClearFormInput })
        },
        IS_RE_SENDEMAIL: (action_reSendEmail) => {
            dispatch({ type: 'reSendEmail', action_reSendEmail })
        },

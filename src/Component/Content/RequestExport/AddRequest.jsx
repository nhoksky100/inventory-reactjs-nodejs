...
class AddRequest extends Component {
    ...
    handleSave = () => {
        const { permission, newRowDataList, newRowDataListTeamp, memberName, memberDepartment, dataRequest } = this.state;
        const promises = [];
    ...
    handleSaveTeamp = async () => {
        ...
        if (this._isMounted) {
            ...
            for (const newRowData of newRowDataList) {
                const { id, orderName, warehouseItemsCode, orderNotes, unit, amount, unitPrice, intoMoney, warehouseAreaName } = newRowData;

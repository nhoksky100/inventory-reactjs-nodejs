...
class PurchaseRequestNotApprove extends Component {
    ...
    sortByDate = (dataRequest) => {
        ...
        if (this._isMounted) {
            ...
            this.setState({
                ...
                dataRequest: currentTodos.reverse(),
    ...
    handleUpdateApproved = (value, pointApprove, index) => {
        if (value.orderSupplierName) {
            const { dataApproveDate, departmentApproveDate, memberName, reasonMessage, dataRequest } = this.state;
    ...
    handleUpdateApproveReturn = (value, pointApprove) => {
        const { dataApproveDate, departmentApproveDate, memberName, reasonMessage } = this.state;

    ...
    handleActionState = (key) => {
        ...
        axios.post('/updateDataMember', {
            ...
            axios.post('/upateAccount', {
                accountCode: pushDataNewMember[0].memberCode,
                accountStatus: pushDataNewMember[0].memberStatus,
                accountDateUpdate: pushDataNewMember[0].memberDateUpdate,
            })
...
const mapDispatchToProps = (dispatch, ownProps) => {
    return {
        ...
        getDatasearchValue: (action_dataSearchValue) => {
            dispatch({ type: 'dataSearchValue', action_dataSearchValue })
        },
        is_DataSearch: (action_isDataSearch) => {
            dispatch({ type: 'isDataSearch', action_isDataSearch })
        },
        SearchDateTimeStart: (act_search_datetime) => {
            dispatch({ type: 'searchDatetimeStart', act_search_datetime })
        },
        SearchDateTimeEnd: (act_search_datetime) => {
            dispatch({ type: 'searchDatetimeEnd', act_search_datetime })
        }
